...
METADATA = {
    ...
    'description':      'The Datapawns are led across the wasteland on a mission',
    'author':           'scav,strings',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'datapawn': 'datapawn',
                   },
    'packages': ['datapawn',
                ],
    'scripts': ['scripts/datapawn'],
}
...
_DATA_DIR = os.path.join('datapawn', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'datapawn': data_dirs}
...
src = []
add_files(src,os.walk('datapawn'))
